...
<div id="modalPengeluaran" class="modal-overlay">
    <div class="modal-content" style="max-width: 450px;">
        ...
        <form action="{{ route('keuangan.cashflow.store') }}" method="POST">
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;"><button type="button" onclick="closeModal('modalPengeluaran')" class="btn-action" style="flex:1; background:#f1f5f9; color:#64748b; justify-content:center;">Batal</button><button type="submit" class="btn-action" style="flex:1; justify-content:center; background:#0081C9; color:white;">Simpan</button></div>
        </form>
    </div>
</div>
...
<div id="modalPemasukan" class="modal-overlay">
    <div class="modal-content" style="max-width: 450px;">
        ...
        <form action="{{ route('keuangan.cashflow.store') }}" method="POST">
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;"><button type="button" onclick="closeModal('modalPemasukan')" class="btn-action" style="flex:1; background:#f1f5f9; color:#64748b; justify-content:center;">Batal</button><button type="submit" class="btn-action" style="flex:1; justify-content:center; background:#2E7D32; color:white;">Simpan</button></div>
        </form>
    </div>
</div>
...
<div id="modalHutang" class="modal-overlay">
    <div class="modal-content" style="max-width: 450px;">
        ...
        <form action="{{ route('keuangan.debt.store') }}" method="POST">
            ...
            <div style="display: flex; gap: 10px; margin-top: 20px;"><button type="button" onclick="closeModal('modalHutang')" class="btn-action" style="flex:1; background:#f1f5f9; color:#64748b; justify-content:center;">Batal</button><button type="submit" class="btn-action" style="flex:1; justify-content:center; background:#0081C9; color:white;">Simpan</button></div>
        </form>
    </div>
</div>
...
<div id="modalPiutang" class="modal-overlay">
    <div class="modal-content" style="max-width: 450px;">
        ...
        <form action="{{ route('keuangan.debt.store') }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 15px;"><label style="font-size: 11px; color: #888; display: block;">Metode Pembayaran (Untuk DP)</label><select name="metode_pembayaran" class="form-control"><option value="">-- Pilih Metode --</option>@foreach($paymentMethods as $pm)<option value="{{ $pm->uuid }}">{{ $pm->nama_metode }}</option>@endforeach</select></div>
            <div class="form-group"><label>Jatuh Tempo *</label><input type="date" name="jatuh_tempo" class="form-control" required></div>
            <div style="display: flex; gap: 10px; margin-top: 20px;"><button type="button" onclick="closeModal('modalPiutang')" class="btn-action" style="flex:1; background:#f1f5f9; color:#64748b; justify-content:center;">Batal</button><button type="submit" class="btn-action" style="flex:1; justify-content:center; background:#2E7D32; color:white;">Simpan</button></div>
        </form>
    </div>
</div>
